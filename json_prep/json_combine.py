...
parser.add_argument("--log_jsons",
                    default="/home/roit/datasets/MineNav/mcv2jsons/combined_logs/center_circle_8.txt"# as traj_name
                    #default=None
                    )
parser.add_argument("--base_path",default='/home/roit/datasets/MineNav/mcv2jsons')
parser.add_argument("--out_json",default='/home/roit/datasets/MineNav/mcv2jsons/combined/center_circle_8.json')
